...
template< class ReadWriteInterface, class OutputType, bool EVEN >
SC_MODULE( ProdCons )
{
  // Ports
  sc_in_clk clock;
  ...
  osss_port_to_rmi< ReadWriteInterface > commIF_producer_port;
  osss_port_to_rmi< ReadWriteInterface > commIF_consumer_port;
