...
#include "TransceiverInterface_stub.hh"
...
SC_MODULE( Transceiver )
{
  ...
  osss_port_to_shared< TransceiverInterface_if > tif_send_port;
  osss_port_to_shared< TransceiverInterface_if > tif_receive_port;
#else
  osss_port_to_rmi< TransceiverInterface_if > tif_send_port;
  osss_port_to_rmi< TransceiverInterface_if > tif_receive_port;
#endif
