...
{
public:
  typedef typename ALU_if<W, IW>::multReturnType   multReturnType;
  typedef typename ALU_if<W, IW>::addSubReturnType addSubReturnType;
  typedef typename ALU_if<W, IW>::divReturnType    divReturnType;

  typedef typename ALU_if<W, IW>::operandType operandType;
