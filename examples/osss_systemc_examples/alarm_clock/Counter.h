...
{
public:
  Counter( const unsigned int lowerBound,
  ...
  void 
  setLowerBound( const unsigned int lowerBound );

  void 
  setUpperBound( const unsigned int upperBound );
  ...
  void 
  count( const unsigned int stepSize = 1 );
