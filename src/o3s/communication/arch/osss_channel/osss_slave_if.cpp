...
osss_slave_if::osss_slave_if()
  : m_address_range( NULL )
{
}
...
bool osss_slave_if::isMaster()
{
  return false;
}

bool osss_slave_if::isSlave()
{
  return true;
}
...
// $Id: osss_slave_if.cpp 2392 2008-07-01 20:45:11Z philipph $
