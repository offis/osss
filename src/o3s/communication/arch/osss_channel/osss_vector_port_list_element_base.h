...
#ifndef OSSS_VECTOR_PORT_LIST_ELEMENT_BASE_HH
#define OSSS_VECTOR_PORT_LIST_ELEMENT_BASE_HH
...
public:
  friend std::ostream& operator<< (std::ostream& o, 
				   const osss_vector_port_list_element_base& vpleb);
  ...
  virtual ~osss_vector_port_list_element_base() {}
...
std::ostream& operator<< (std::ostream& o, 
			  osss_vector_port_list_element_base& vpleb);

} // namespace osss

#endif
// $Id: osss_vector_port_list_element_base.h 2392 2008-07-01 20:45:11Z philipph $
