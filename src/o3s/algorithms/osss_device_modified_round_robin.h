 ...
 * -----------------------------------------------------------------------
 */
#ifndef OSSS_DEVICE_MODIFIED_ROUND_ROBIN_H_INCLUDED_
#define OSSS_DEVICE_MODIFIED_ROUND_ROBIN_H_INCLUDED_

#include "osss_device_round_robin.h"
...
class osss_device_modified_round_robin
  : public osss_device_round_robin
{
public:
  //! \brief Constructor.
  //!
  ...
  //! scheduler class.
  osss_device_modified_round_robin()
    {}
  ...
  //! ring).
  virtual
  osss_device_job_idx schedule();

};

OSSS_SYNTHESISABLE_END_
OSSS_SYNTHESISABLE_EXPORT_( osss_device_modified_round_robin );

} // namespace osss

#ifdef OSSS_SYNTHESIS_
#  include "osss_device_modified_round_robin.cpp"
#endif

#endif // OSSS_DEVICE_MODIFIED_ROUND_ROBIN_H_INCLUDED_
// $Id: osss_device_modified_round_robin.h 2917 2008-12-15 18:25:33Z philipph $
