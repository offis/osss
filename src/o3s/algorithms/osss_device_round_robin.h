 ...
 * -----------------------------------------------------------------------
 */
#ifndef OSSS_DEVICE_ROUND_ROBIN_H_INCLUDED_
#define OSSS_DEVICE_ROUND_ROBIN_H_INCLUDED_
...
class osss_device_round_robin
  : public osss_device_scheduler
{
public:
...
protected:
  ...
  osss_device_job_idx m_last_grant;
  bool                m_last_grant_initialised;

};

OSSS_SYNTHESISABLE_END_
OSSS_SYNTHESISABLE_EXPORT_(osss_device_round_robin);

} // namespace osss

#ifdef OSSS_SYNTHESIS_
#  include "osss_device_round_robin.cpp"
#endif // OSSS_SYNTHESIS_

#endif // OSSS_DEVICE_ROUND_ROBIN_H_INCLUDED_
// $Id: osss_device_round_robin.h 2917 2008-12-15 18:25:33Z philipph $
