 ...
 * -----------------------------------------------------------------------
 */
#ifndef OSSS_ROUND_ROBIN_H_INCLUDED_
#define OSSS_ROUND_ROBIN_H_INCLUDED_
...
public:
  ...
  explicit
  osss_round_robin( osss_index_type noc );
...
protected:
  ...
  osss_index_type m_lastGrant;

};

OSSS_SYNTHESISABLE_END_
OSSS_SYNTHESISABLE_EXPORT_( osss_round_robin );

} //namespace osss

#ifdef OSSS_SYNTHESIS_
#  include "osss_round_robin.cpp"
#endif

#endif // OSSS_ROUND_ROBIN_H_INCLUDED_
// $Id: osss_round_robin.h 2914 2008-12-15 18:25:24Z philipph $
