...
osss_device_round_robin::osss_device_round_robin()
{
  // we don't know the number of jobs here
  m_last_grant_initialised = false;
}

//-----------------------------------------------------------------------//

osss_device_job_idx
osss_device_round_robin::schedule()
{
...
//-----------------------------------------------------------------------//
// $Id: osss_device_round_robin.cpp 2918 2008-12-15 18:25:36Z philipph $
