 ...
 * -----------------------------------------------------------------------
 */
#ifndef OSSS_SERIALISABLE_ARRAY_HH
#define OSSS_SERIALISABLE_ARRAY_HH
...
/**
 * \class osss_serialisable_array
 *
 * \brief This class provides a synthesisable AND serialisable array of a 
 *        fixed size. 
 * All types T inside this class need to be either
...
class osss_serialisable_array
  : public osss_array<T, Size>
  , public osss_serialisable_object
{
public:
  typedef osss_array<T, Size> base_type;

  typedef typename base_type::reference       reference;
  typedef typename base_type::const_reference const_reference;
  typedef typename base_type::size_type       size_type;

  OSSS_IS_SERIALISABLE( osss_serialisable_array );

  //! \brief Constructor. 
  //!
  //! Creates an empty array of size 'Size'
  OSSS_SERIALISABLE_CTOR(osss_serialisable_array, ());
  
  //! \brief Copy constructor. 
  //!
  //! Creates a new array as exact copy of the passed one.
  OSSS_SERIALISABLE_CTOR(osss_serialisable_array,
                         (const osss_serialisable_array<T, Size> & sourceArray));

  ~osss_serialisable_array();
  ...
  /// export array size, instead of bit size
...
#include "o3s/datatypes/osss_serialisable_array.tpp"

#endif // OSSS_SERIALISABLE_ARRAY_HH
// $Id: osss_serialisable_array.h 2740 2008-11-27 09:50:41Z philipph $
